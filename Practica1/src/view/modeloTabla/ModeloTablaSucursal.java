...
public class ModeloTablaSucursal extends AbstractTableModel{
    ...
    public Object getValueAt(int i, int i1) {
        Sucursal s = null;
        Double mediaVentas = null;
        Double ventas = null;
        try {
            s = lista.get(i);
            ventas = Utilities.sumarVentas(s);
            mediaVentas = Utilities.mediaVentas(s);
        ...
        switch(i1){
            ...
            case 1: return (s != null) ? ventas : 0.0;
            case 2: return (s != null) ? mediaVentas : 0.0;
            default: return null;
        }
    }
